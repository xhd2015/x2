...
_int0x25:
	...
	movl	%esp, %ebp
/APP
 # 559 "interrupts.cpp" 1
	pusha 
	
 # 0 "" 2
 # 564 "interrupts.cpp" 1
	mov 4*3(%ebp),%eax 
	or $0x200,%eax 
	mov %eax,4*3(%ebp) 
