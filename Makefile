...
#DEPRECATED,using -imacro FILE instead
...
$(INCLUDECONCEPTUAL)/configurations.h:Config.makefile
	...
	echo Generating $@
	(
		echo	'//====this file is automatically generated,see Config.makefile about all details===='
		echo	'//====PLEASE DO NOT EDIT IT==='
		echo	'#ifndef INCLUDE_MACROS_CONFIGURATIONS_H_'
		echo	'#define INCLUDE_MACROS_CONFIGURATIONS_H_'
		echo
		echo -e '$(CCMACROS_DEFINES)'
		echo	'#endif /* INCLUDE_MACROS_CONFIGURATIONS_H_ */'
	) > $@
